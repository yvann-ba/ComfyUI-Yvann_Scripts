...
function provisioning_start() {
	...
	cd ../diffusion_models/
	wget -O wan-14B_vace_phantom_v2_LowSteps%5BCausvid%5D_fp8_e4m3fn.safetensors https://huggingface.co/Inner-Reflections/Wan2.1_VACE_Phantom/resolve/main/wan-14B_vace_phantom_v2_LowSteps%5BCausvid%5D_fp8_e4m3fn.safetensors?download=true
