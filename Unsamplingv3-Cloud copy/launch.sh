...
function provisioning_start() {
    ...
    cd checkpoints
    wget -O fenrisxlFlux_fenrisxlSDXLLightning.safetensors https://civitai.com/api/download/models/370565?type=Model&format=SafeTensor&size=full&fp=fp16
    cd ../vae
    ...
    mkdir ipadapter
    cd ipadapter
    wget -O ip-adapter_plus_sdxl_vit-h.safetensors https://huggingface.co/h94/IP-Adapter/resolve/main/sdxl_models/ip-adapter-plus_sdxl_vit-h.safetensors
    ...
    cd ../controlnet
    wget -O cannyXL.safetensors https://huggingface.co/xinsir/controlnet-canny-sdxl-1.0/resolve/main/diffusion_pytorch_model_V2.safetensors?download=true
